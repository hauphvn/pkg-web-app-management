    ...
    return (
        <div className={'flex flex-col gap-y-[24px] mb-4'}>
            <div onClick={handleLogout}
                ...
                <IconLogout/>
                <div className={'text-[#7E808A] text-[18px] font-[500] hover:text-primary'}>Đăng xuất</div>
            </div>
            <div className="theme-container w-full bg-[#EBEBEF] rounded-[8px] grid grid-cols-2 h-[37px]">
